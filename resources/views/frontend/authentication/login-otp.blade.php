<x-auth-layout
    pageTitle="Otp Verify | {{ readConfig('site_name') }}"
    title="Verify your code"
    subtitle="Please enter the 5-digit code we emailed you."
    illustration="login.svg">

    <form action="{{ route('login.otp') }}" method="post" class="auth-form">
        @csrf
    ...
    <x-slot:footer>
        <p>Didn't receive the email? <a href="{{ route('resend.login.otp') }}">Resend code</a></p>
