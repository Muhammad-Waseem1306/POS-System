                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a href="{{route('backend.admin.installments.index')}}"
                            class="nav-link {{ request()->routeIs(['backend.admin.installments.index', 'backend.admin.installments.show']) ? 'active' : '' }}">
                            <i class="fas fa-circle nav-icon"></i>
                            <p>Installments</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('backend.admin.installment-dashboard.index') }}"
                            class="nav-link {{ request()->routeIs('backend.admin.installment-dashboard.*') ? 'active' : '' }}">
                            <i class="fas fa-circle nav-icon"></i>
                            <p>Installment Monitor
                                @php $overdue = \App\Models\InstallmentSchedule::where('status','overdue')->count(); @endphp
                                @if($overdue > 0)<span class="badge badge-danger right">{{ $overdue }}</span>@endif
                            </p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('backend.admin.cash-register.index') }}"
                            class="nav-link {{ request()->routeIs('backend.admin.cash-register.*') ? 'active' : '' }}">
                            <i class="fas fa-circle nav-icon"></i>
                            <p>Cash Register</p>
                        </a>
                    </li>
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('backend.admin.reports.advanced.sales-by-day') }}"
                            class="nav-link {{ request()->routeIs('backend.admin.reports.advanced.*') ? 'active' : '' }}">
                            <i class="fas fa-circle nav-icon"></i>
            ...
            <li class="nav-item">
                <a href="{{ route('backend.admin.notifications.index') }}"
                    ...
                    <p>Notifications
                        ...
                        @if($notifCount > 0)<span class="badge badge-danger right">{{ $notifCount }}</span>@endif
                    </p>
                </a>
            </li>
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('backend.admin.backup.index') }}"
                            class="nav-link {{ request()->routeIs('backend.admin.backup.*') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('backend.admin.audit-logs.index') }}"
                            class="nav-link {{ request()->routeIs('backend.admin.audit-logs.*') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('backend.admin.system-health.index') }}"
                            class="nav-link {{ request()->routeIs('backend.admin.system-health.*') ? 'active' : '' }}">
