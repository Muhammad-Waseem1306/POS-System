  ...
  <div class="receipt-container mt-0" id="printable-section" style="max-width: {{ $maxWidth}}; font-size: 12px; font-family: 'Courier New', Courier, monospace;">
    ...
    <table style="width: 100%;">
      <thead>
        <tr>
          ...
          <!-- <th style="text-align: right;">Price {{ currency() ? currency()->symbol : '$'}}</th> -->
          <th style="text-align: right;">Total {{ currency() ? currency()->symbol : '$'}}</th>
        </tr>
      </thead>
      <tbody>
    ...
    <div class="summary">
      <table style="width: 100%;">
        <tr>
          <td>Subtotal:</td>
          <td class="text-right">{{number_format((float)$order->sub_total, 2) }}</td>
        </tr>
        <tr>
          <td>Discount:</td>
        ...
        <tr>
          <td>Paid:</td>
          <td class="text-right">{{number_format((float)$order->paid, 2) }}</td>
        </tr>
        <tr>
          <td>Due:</td>
          <td class="text-right">{{number_format((float)$order->due, 2) }}</td>
        </tr>
      </table>
    </div>
    <hr>
